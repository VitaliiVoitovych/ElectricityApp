namespace ElectricityApp.Exceptions;
...
public class DuplicateConsumptionNoteException : Exception
{
    ...
    public static void ThrowIfDuplicateExists(IEnumerable<ElectricityConsumption> consumptions, ElectricityConsumption consumption)
    {
